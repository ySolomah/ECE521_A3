...
with np.load("notMNIST.npz") as data:
    ...
    for hiddenCount, colour in zip(num_neurons, ['mo', 'bo', 'ro', 'go', 'yo']):
        ...
        intermediateLayer2, regularizeW2, W2, b2 = fcLayer(featureMap, hiddenCount, spatialSize=hiddenCount, lamb=lam)
        featureMap2 = tf.nn.relu(intermediateLayer2)
        outputLayer, regularizeW3, W3, b3 = fcLayer(featureMap2, 10, spatialSize=hiddenCount, lamb=lam)        
        ...
        total_loss = loss + regularizeW1 + regularizeW2 + regularizeW3
